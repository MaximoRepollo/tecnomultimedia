class Aventura{
  ...
  PFont nfuente;
  float pantalla, Xt ;
  BotonCirc [] boton= new BotonCirc[39];
  Juego juego;
  Creditos creditos;
  Texto [] texto= new Texto[40];
  Fondo  fondo;
  Aventura(){
    creditos = new Creditos();
    juego= new Juego();
    fondo = new Fondo();
    opc[0] = "La gran aventura\n  de Chomp";
    opc[1]= "Iniciar";
    opc[2]="Creditos";
    opc[3]="Preguntar\n por\n hermano";
    opc[4]="Saquear";
  ...
  finales[7]="Final muerto:\n Chomp toma el arco,pero no flechas, por\n lo que es aniquilado.";
    ...
    boton [37] = new BotonCirc ("Continuar",width/2,500,200 );
    ...
    texto[29]= new Texto("Final muerto:\n Chomp pierde la batalla.",width/2,40,30,color(255));
   ...
   fondo.impr(10);
    ...
    boton[21].dibujar();
     ...
     if (juego.estadojuego.equals("gane")){
      ...
      else if (juego.estadojuego.equals("perdi")){
        pantalla = 29;
     }
     else if (juego.estadojuego.equals("creditos")){
       pantalla = 28;
     }
  }
  else if(pantalla==17){
